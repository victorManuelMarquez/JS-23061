for (let i=1; i<=16; i++) {
    ...
    $("#codeTP2-"+i).load("Ejercicio_" + i + ".js");

    document.getElementById("tp2-ejercicio-" + i).querySelector('.card-title').append(i);
    ...
    let button = document.getElementById("playTP2-" + i);
    button.onclick = function () {
        ...
        let logger = document.getElementById("outputTP2-" + i);
